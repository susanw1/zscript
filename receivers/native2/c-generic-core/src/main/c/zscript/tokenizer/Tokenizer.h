...
static const uint8_t ZSTOK_ERROR_CODE_ODD_BIGFIELD_LENGTH   = 0xf2;
...
static void zstok_initTokenizer(ZStok_Tokenizer *pTokenizer, ZStok_TokenWriter writer, uint8_t maxNumericBytes);
