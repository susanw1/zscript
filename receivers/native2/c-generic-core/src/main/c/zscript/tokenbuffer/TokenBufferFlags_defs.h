...
/**
 * Creates a freshly initialized ZStok_BufferFlags *by value*.
 ...
 */
inline static void zstok_setMarkerWritten(ZStok_BufferFlags *bf) {
 ...
 */
inline static bool zstok_getAndClearMarkerWritten(ZStok_BufferFlags *bf) {
    if (bf->markerWritten) {
 ...
 */
inline static void zstok_setSeqMarkerWritten(ZStok_BufferFlags *bf) {
 ...
 * @return true if set, false otherwise
 */
inline static bool zstok_getAndClearSeqMarkerWritten(ZStok_BufferFlags *bf) {
 ...
 */
inline static bool zstok_isReaderBlocked(const ZStok_BufferFlags *bf) {
 ...
 */
inline static void zstok_setReaderBlocked(ZStok_BufferFlags *bf) {
    bf->readerBlocked = true;
}

/**
 * Used by a Reader to signal that it is not (or no longer) blocked, and can proceed with processing tokens if given the chance.
 *
 ...
 */
inline static void zstok_clearReaderBlocked(ZStok_BufferFlags *bf) {
    bf->readerBlocked = false;
}

/**
 * Indicates whether the Buffer has detected a usage error or been put in an unstable state.
 *
 * This should be checked and raised as an error condition.
 *
 * @return true if the buffer is in error state, false otherwise
 */
inline static bool zstok_isFatalBufferError(const ZStok_BufferFlags *bf) {
 ...
 */
inline static void zstok_setFatalBufferError(ZStok_BufferFlags *bf) {
