...
class ZcodeTokenBufferTest {
    ...
    private ZcodeTokenRingBuffer buffer = ZcodeTokenRingBuffer.createBufferWithCapacity(6);

    @Test
    void shouldTokenizeNumericFieldWithNoValue() {
        buffer.startToken((byte) 'A', true);
        assertThat(buffer.getInternalData()).containsExactly(0, 'A', 0, 0, 0, 0);
    }
    ...
    void shouldTokenizeNumericFieldWithValue() {
        ...
        buffer.closeToken();
        assertThat(buffer.getInternalData()).containsExactly(1, 'A', 5, 0, 0, 0);
    }
    ...
    void shouldTokenizeNumericFieldWithByteValue() {
        ...
        assertThat(buffer.getInternalData()).containsExactly(1, 'A', (byte) 234, 0, 0, 0);
    }
    ...
    void shouldTokenizeNumericFieldWith2NibbleValue() {
        ...
        assertThat(buffer.getInternalData()).containsExactly(1, 'A', 0x5d, 0, 0, 0);
    }
    ...
    void shouldTokenizeNumericFieldWith3NibbleValue() {
        ...
        buffer.closeToken();
        assertThat(buffer.getInternalData()).containsExactly(2, 'A', 0x5, 0xda, 0, 0);
    }
    ...
    void shouldTokenizeNumericFieldWith4NibbleValue() {
        ...
        buffer.closeToken();
        assertThat(buffer.getInternalData()).containsExactly(2, 'A', 0x5d, 0xa3, 0, 0);
    }
    ...
    void shouldTokenize2NumericFields() {
        ...
        buffer.closeToken();
        assertThat(buffer.getInternalData()).containsExactly(0, 'A', 0, 'B', 0, 0);
    }
    ...
    void shouldTokenize2NumericFieldsWithValues() {
        ...
        buffer.startToken((byte) 'B', true);
        buffer.closeToken();
        assertThat(buffer.getInternalData()).containsExactly(1, 'A', 5, 0, 'B', 0);
    }
    ...
    void shouldTokenizeNonNumericField() {
        ...
        buffer.closeToken();
        assertThat(buffer.getInternalData()).containsExactly(0, '+', 0, 0, 0, 0);
    }
    ...
    void shouldTokenize2NonNumericFields() {
        ...
        buffer.startToken((byte) '+', false);
        buffer.closeToken();
        assertThat(buffer.getInternalData()).containsExactly(0, '+', 0, '+', 0, 0);
    }
    ...
    void shouldTokenize2NonNumericFieldsWithValues() {
        ...
        buffer.startToken((byte) '+', false);
        buffer.closeToken();
        assertThat(buffer.getInternalData()).containsExactly(1, '+', 0x5a, 0, '+', 0);
    }
    ...
    void shouldTokenizeMixedFieldsWithOddNibbleValues() {
        ...
        buffer.startToken((byte) '+', false);
        buffer.closeToken();
        assertThat(buffer.getInternalData()).containsExactly(2, 'A', 0x5, (byte) 0xab, 0, '+');
    }
