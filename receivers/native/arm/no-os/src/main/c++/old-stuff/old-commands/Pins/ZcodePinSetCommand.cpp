...
#include "../../old-commands/Pins/ZcodePinSetCommand.hpp"

void ZcodePinSetCommand::execute(ZcodeCommandSlot<ZcodeParameters> *slot, ZcodeCommandSequence<ZcodeParameters> *sequence, ZcodeOutStream<ZcodeParameters> *out) {
