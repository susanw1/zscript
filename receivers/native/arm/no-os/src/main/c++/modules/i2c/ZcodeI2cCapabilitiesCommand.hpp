#ifndef SRC_TEST_CPP_ZCODE_COMMANDS_ZCODEI2CCAPABILITIESCOMMAND_HPP_
#define SRC_TEST_CPP_ZCODE_COMMANDS_ZCODEI2CCAPABILITIESCOMMAND_HPP_
...
#endif /* SRC_TEST_CPP_ZCODE_COMMANDS_ZCODEI2CCAPABILITIESCOMMAND_HPP_ */
