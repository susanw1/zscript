...
#ifndef SRC_MAIN_C___ARM_NO_OS_PINS_MODULE_COMMANDS_ZCODEPINSETUPCOMMAND_HPP_
#define SRC_MAIN_C___ARM_NO_OS_PINS_MODULE_COMMANDS_ZCODEPINSETUPCOMMAND_HPP_
...
#endif /* SRC_MAIN_C___ARM_NO_OS_PINS_MODULE_COMMANDS_ZCODEPINSETUPCOMMAND_HPP_ */
