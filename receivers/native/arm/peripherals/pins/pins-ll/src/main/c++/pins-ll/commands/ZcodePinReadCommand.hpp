...
#ifndef SRC_MAIN_CPP_ARM_NO_OS_PINS_MODULE_COMMANDS_ZCODEPINREADCOMMAND_HPP_
#define SRC_MAIN_CPP_ARM_NO_OS_PINS_MODULE_COMMANDS_ZCODEPINREADCOMMAND_HPP_
...
#endif /* SRC_MAIN_CPP_ARM_NO_OS_PINS_MODULE_COMMANDS_ZCODEPINREADCOMMAND_HPP_ */
