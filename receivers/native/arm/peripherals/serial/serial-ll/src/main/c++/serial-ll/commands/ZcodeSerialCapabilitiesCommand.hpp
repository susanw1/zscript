...
public:
    ...
    static void execute(ZcodeExecutionCommandSlot<ZP> slot) {
        ...
        out->writeField8('P', SerialManager<LL>::serialCount);
        out->writeField32('F', SerialManager<LL>::getSerialById(0)->getMaxBaud());
        out->writeField16('B', LL::SerialBufferTxSize);
        out->writeField16('R', LL::SerialBufferRxSize);
        out->writeStatus(OK);
    }
