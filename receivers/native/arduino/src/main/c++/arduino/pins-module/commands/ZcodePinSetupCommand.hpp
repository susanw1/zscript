...
#ifndef SRC_MAIN_CPP_ARDUINO_PINS_MODULE_COMMANDS_ZCODEPINSETUPCOMMAND_HPP_
#define SRC_MAIN_CPP_ARDUINO_PINS_MODULE_COMMANDS_ZCODEPINSETUPCOMMAND_HPP_
...
#endif /* SRC_MAIN_CPP_ARDUINO_PINS_MODULE_COMMANDS_ZCODEPINSETUPCOMMAND_HPP_ */
