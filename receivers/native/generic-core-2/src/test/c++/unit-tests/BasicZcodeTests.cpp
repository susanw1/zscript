...
int main(void) {
    ...
    if (!ZcodeTestingSystem::tryTest("Z0", "SC3107M7N14+000102\n")) {
        std::cerr << "Failed on Capabilities\n";
        return 1;
    }
    if (!ZcodeTestingSystem::tryTest("Z0000", "SC3107M7N14+000102\n")) {
        std::cerr << "Failed on Capabilities\n";
        return 1;
    }
    if (!ZcodeTestingSystem::tryTest("Z", "SC3107M7N14+000102\n")) {
