/*
 * RCodePinInterruptSource.hpp
 *
 *  Created on: 12 Jan 2021
 *      Author: robert
 */

#ifndef SRC_TEST_C___COMMANDS_PINS_RCODEPININTERRUPTSOURCE_HPP_
#define SRC_TEST_C___COMMANDS_PINS_RCODEPININTERRUPTSOURCE_HPP_
...
class RCodePinInterruptSource: public RCodeBusInterruptSource<RCodeParameters> {
...
public:
    ...
    uint8_t getNotificationBus(uint8_t id) {
        ...
        uint8_t num = RCodePinSystem::getPinNumber(pinName);
        return num;
    }
...
#endif /* SRC_TEST_C___COMMANDS_PINS_RCODEPININTERRUPTSOURCE_HPP_ */
