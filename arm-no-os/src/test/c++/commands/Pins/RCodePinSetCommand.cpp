/*
 * RCodePinSetCommand.cpp
 *
 *  Created on: 12 Jan 2021
 *      Author: robert
 */

#include "RCodePinSetCommand.hpp"

void RCodePinSetCommand::execute(RCodeCommandSlot<RCodeParameters> *slot, RCodeCommandSequence<RCodeParameters> *sequence,
