...
void RCodeI2cBus::asyncTransmit(uint16_t addr, const uint8_t *txBuffer, uint8_t txLen, RCodeCommandSlot *callbackSlot,
...
void RCodeI2cBus::asyncReceive(uint16_t addr, uint8_t rxLen, RCodeCommandSlot *callbackSlot,
        void (*callbackFunc)(I2cTerminationStatus, RCodeCommandSlot*, uint8_t), uint8_t callbackData) {
    phyBus->asyncReceive(addr, rxLen, callbackSlot, callbackFunc, callbackData);
}

void RCodeI2cBus::asyncTransmitReceive(uint16_t addr, const uint8_t *txBuffer, uint8_t txLen, uint8_t rxLen, RCodeCommandSlot *callbackSlot,
        void (*callbackFunc)(I2cTerminationStatus, RCodeCommandSlot*, uint8_t), uint8_t callbackData) {
