...
public:
    void peripheralRead(const uint8_t *peripheral, bool incrementPeripheral, uint8_t *memory, bool incrementMemory, uint16_t transferLength, bool circular,
            DmaPriority priority, void (*callback)(Dma*, DmaTerminationStatus), bool interruptOnHalf) {
        setupGeneric(peripheral, incrementPeripheral, 0, memory, incrementMemory, 0, false, transferLength, 0, circular, priority, callback, interruptOnHalf);
    }

    void peripheralWrite(const uint8_t *memory, bool incrementMemory, uint8_t *peripheral, bool incrementPeripheral, uint16_t transferLength, bool circular,
            DmaPriority priority, void (*callback)(Dma*, DmaTerminationStatus), bool interruptOnHalf) {
        setupGeneric(peripheral, incrementPeripheral, 0, memory, incrementMemory, 0, false, transferLength, 1, circular, priority, callback, interruptOnHalf);
    }
    ...
    void memCopy(const uint16_t *source, bool increment, uint16_t *target, uint16_t transferLength, DmaPriority priority,
            void (*callback)(Dma*, DmaTerminationStatus), bool interruptOnHalf) {
        setupGeneric((uint8_t*) source, increment, 1, (uint8_t*) target, true, 1, true, transferLength, 0, false, priority, callback, interruptOnHalf);
    }

    void memCopy(const uint32_t *source, bool increment, uint32_t *target, uint16_t transferLength, DmaPriority priority,
            void (*callback)(Dma*, DmaTerminationStatus), bool interruptOnHalf) {
        setupGeneric((uint8_t*) source, increment, 2, (uint8_t*) target, true, 2, true, transferLength, 0, false, priority, callback, interruptOnHalf);
    }
    ...
    void setupGeneric(const uint8_t *peripheralOrSource, bool peripheralOrSourceIncrement, uint8_t peripheralOrSourceSize, const uint8_t *target,
