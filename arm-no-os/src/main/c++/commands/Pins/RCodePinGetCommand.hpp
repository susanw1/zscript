...
class RCodePinGetCommand: public RCodeCommand<RCodeParameters> {
private:
...
public:
    ...
    bool matchesCode(uint8_t code[], uint8_t length) const {
        return length == 1 && code[0] == RCodePinGetCommand::code;
    }
...
#endif /* SRC_TEST_C___COMMANDS_PINS_RCODEPINGETCOMMAND_HPP_ */
