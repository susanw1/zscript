...
public class CoreRCodeSteps {
    ...
    public void the_target_is_sent_multiple_echo_commands() {
        testAssert = assertThatCommand(RCodeAcceptanceTestConnectionManager.getConnections().get(0), "R1A10&R1+21BC&R1\"aaa\"\n");
    ...
    public void the_target_is_sent_multiple_echo_commands_inc_error_handlers() {
        testAssert = assertThatCommand(RCodeAcceptanceTestConnectionManager.getConnections().get(0), "R1A10&R1+21BC|R1A2&R1+33\n");
    ...
    public void the_target_is_sent_multiple_echo_commands_one_of_which_gives_s10_in_a_sequence() {
        testAssert = assertThatCommand(RCodeAcceptanceTestConnectionManager.getConnections().get(0), "R1A10&R1S10&R1A2&R1+12\n");
        testExpectedFields = a -> a.worked().hasField('A', "10").sequenceContinues().next().hasStatus(RCodeAcceptanceTestResponseStatus.CMD_FAIL).isLastInSequence();
    }
    ...
    public void the_target_is_sent_multiple_echo_commands_one_of_which_gives_s10_in_a_sequence_with_error_handler() {
        testAssert = assertThatCommand(RCodeAcceptanceTestConnectionManager.getConnections().get(0), "R1A10&R1S10+21BC&R1|R1A2&R1+44\n");
        testExpectedFields = a -> a.worked().hasField('A', "10").sequenceContinues().next().hasStatus(RCodeAcceptanceTestResponseStatus.CMD_FAIL).sequenceHasError().next().worked()
    ...
    public void the_target_is_sent_multiple_echo_commands_one_of_which_gives_s5_in_a_sequence_with_error_handler() {
        testAssert = assertThatCommand(RCodeAcceptanceTestConnectionManager.getConnections().get(0), "R1A10&R1S5+21BC&R1|R1A2&R1+44\n");
