Feature: Core RCode communication
	The target must support the basic RCode functionality (R0, R1, R2), and should support the general functionality most RCode systems can be expected to have (R6, R3), 
	as well as any of the more optional functionality it claims to support, all within the core (system) RCode space. This does not include any peripherals, 
