...
public class Main3 {
    ...
    public static void main(String[] args) {
        ...
        device.getEntity().connectNew(I2cProtocolCategory.class);
        device.getEntity().getConnection(I2cProtocolCategory.class, 0).addProtocol(new I2cConnection(device.getEntity().getConnection(I2cProtocolCategory.class, 0)));
        device.getEntity().getConnection(I2cProtocolCategory.class, 0).addProtocol(new SmBusAlertConnection(device.getEntity().getConnection(I2cProtocolCategory.class, 0)));
        device.getEntity().connectNew(I2cProtocolCategory.class);
        device.getEntity().getConnection(I2cProtocolCategory.class, 1).addProtocol(new I2cConnection(device.getEntity().getConnection(I2cProtocolCategory.class, 1)));
        SmBusAlertConnection alertBetween = new SmBusAlertConnection(device.getEntity().getConnection(I2cProtocolCategory.class, 1));
        device.getEntity().getConnection(I2cProtocolCategory.class, 1).addProtocol(alertBetween);
        ...
        device2.getEntity().getConnection(I2cProtocolCategory.class, 0).addProtocol(new I2cConnection(device2.getEntity().getConnection(I2cProtocolCategory.class, 0)));
        device2.getEntity().getConnection(I2cProtocolCategory.class, 0).addProtocol(new SmBusAlertConnection(device2.getEntity().getConnection(I2cProtocolCategory.class, 0)));
        device2.getEntity().connectNew(I2cProtocolCategory.class);
        ...
        device2.getEntity().connect(I2cProtocolCategory.class, 1, io.getEntity(), 0);
        ...
        I2C.sendMessage(io.getEntity(), new I2cSendPacket(new I2cAddress(0x10), "Z2&Z18N&Z51NAP1&Z52P1A12\"Z1=0a\"\n".getBytes(StandardCharsets.UTF_8))); // set
        // IODIR
        try {
